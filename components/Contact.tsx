  ...
  <section id="contato" className="py-24 bg-[#fafafa]">
    <div className="max-w-5xl mx-auto px-4 text-center">
      ...
      <div className="grid md:grid-cols-2 gap-8 mb-16">
        <a href={WHATSAPP_URL} target="_blank" rel="noopener noreferrer" className="bg-white p-10 shadow-sm border border-transparent hover:border-gold transition-all group no-underline">
        ...
        <div className="bg-white p-10 shadow-sm border border-transparent">
