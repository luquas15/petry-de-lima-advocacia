import { Users, Award, Scale, ShieldCheck } from 'lucide-react';

const areas = [
  { title: "Direito de Família", desc: "Divórcio, Guarda, Pensão, Reconhecimento de União Estável e Adoção.", icon: <Users size={28} /> },
  { title: "Sucessões", desc: "Inventários Judiciais e Extrajudiciais, Testamentos e Planejamento Sucessório.", icon: <Award size={28} /> },
  ...
  <section id="atuacao" className="py-24 bg-[#f9f9f9]">
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
        {areas.map((area, idx) => (
          <div key={idx} className="bg-white p-10 border border-slate-100 hover:border-gold/50 transition-all duration-500 group relative">
