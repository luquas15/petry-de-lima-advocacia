    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      <div className="flex flex-col md:flex-row items-center justify-between gap-12">
        ...
        <div className="md:w-2/3 grid grid-cols-1 sm:grid-cols-2 gap-6">
          ...
          <a href="https://www.youtube.com/watch?v=9FN00ieCBCg" target="_blank" rel="noopener noreferrer" className="p-8 bg-slate-50 border-l-4 border-gold flex flex-col gap-4 group hover:bg-slate-100 transition-all hover:shadow-lg no-underline">
